...
{
    $sql = "update mini_products set product_name='$product_name',product_price='$product_price',product_image='$file_url',final_discounted_price='$final_discounted_price',features='$features',ratings='$ratings' where product_id='$product_id'";
