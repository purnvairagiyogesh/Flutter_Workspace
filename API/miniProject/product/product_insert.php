...
{
    $sql = "insert into products (product_name,product_price,product_image,final_discounted_price,features,ratings) values ('$product_name','$product_price','$file_url','$final_discounted_price','$features','$ratings')";
