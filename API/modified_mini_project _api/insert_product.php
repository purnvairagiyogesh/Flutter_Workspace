...
if($product_name==""&&$product_price==""&&$final_discounted_price==""&&$features==""&&$ratings==""&&$quantity=="")
{
    echo '0';
}
else
{
    $sql = "insert into mini_products (product_name,product_price,product_image,final_discounted_price,features,ratings,quantity) values ('$product_name','$product_price','$file_url','$final_discounted_price','$features','$ratings','$quantity')";
